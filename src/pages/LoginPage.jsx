      ...
      <div className="flex-grow flex items-center justify-center py-20 px-4 relative">
        <div className="w-full max-w-md relative">
          ...
          <div className="bg-[#F9F9F9] p-8 rounded-sm shadow-sm border border-gray-100">
            ...
            {successMsg && (
              <div className="flex items-center gap-2 text-green-600 text-sm bg-green-50 p-3 rounded-sm border border-green-100 mb-6">
                  ...
                  {mode === 'login' && (
                    <div className="flex justify-end mt-2">
                      <button 
                        ...
                        className="text-xs text-gray-400 hover:text-[#B08D55]"
                      >
                        Forgot Password?
                      </button>
                    </div>
            ...
            {mode !== 'forgot' && (
              <>
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 48 48"><path fill="#EA4335" d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l8.06 6.21C12.06 13.52 17.53 9.5 24 9.5z" /><path fill="#4285F4" d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z" /><path fill="#FBBC05" d="M10.6 28.71c-.48-1.45-.76-2.99-.76-4.6s.27-3.14.76-4.6l-8.06-6.21C.96 16.07 0 20.01 0 24s.96 7.93 2.56 11.11l8.04-6.4z" /><path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.47 0-11.94-4.02-13.9-9.42l-8.06 6.21C6.51 42.62 14.62 48 24 48z" /><path fill="none" d="M0 0h48v48H0z" /></svg>
