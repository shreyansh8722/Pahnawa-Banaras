...
export const ProductCard = ({ item, onAddToCart, isFavorite, onToggleFavorite }) => {
  ...
  // Fallback to primary if no secondary image exists
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Secondary Image (Fades In + Slight Zoom) */}
        <img 
          src={secondaryImage} 
          alt={item.name} 
      ...
      <button 
         ...
         disabled={isOutOfStock}
         className="md:hidden mt-3 w-full border border-gray-200 py-2.5 text-[10px] font-bold uppercase tracking-widest text-gray-900 hover:border-[#B08D55] hover:text-[#B08D55] transition-colors disabled:opacity-50"
      >
